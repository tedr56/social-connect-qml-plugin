...
# Instagram
HEADERS += src/instagram/instagramconnection.h \
    src/instagram/instagramrequest.h \
    src/instagram/instagramconstants.h

SOURCES += src/instagram/instagramconnection.cpp \
    src/instagram/instagramrequest.cpp
